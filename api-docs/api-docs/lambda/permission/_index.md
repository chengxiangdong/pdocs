...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#principal_csharp" style="color: inherit; text-decoration: inherit;">Principal</a>
    ...
    <dd><p>The principal who is getting this permissionE.g., <code>s3.amazonaws.com</code>, an AWS account ID, or any valid AWS service principal such as <code>events.amazonaws.com</code> or <code>sns.amazonaws.com</code>.</p>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#qualifier_csharp" style="color: inherit; text-decoration: inherit;">Qualifier</a>
    ...
    <dd><p>Query parameter to specify function version or alias name. The permission will then apply to the specific qualified ARNE.g., <code>arn:aws:lambda:aws-region:acct-id:function:function-name:2</code></p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#statementidprefix_csharp" style="color: inherit; text-decoration: inherit;">Statement<wbr>Id<wbr>Prefix</a>
    ...
    <dd><p>A statement identifier prefix. This provider will generate a unique suffix. Conflicts with <code>statement_id</code>.</p>
</dd></dl>
</pulumi-choosable>
</div>
