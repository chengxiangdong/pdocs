...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#applications_csharp" style="color: inherit; text-decoration: inherit;">Applications</a>
    ...
    <dd><p>List of applications for the cluster. Valid values are: <code>Flink</code>, <code>Hadoop</code>, <code>Hive</code>, <code>Mahout</code>, <code>Pig</code>, <code>Spark</code>, and <code>JupyterHub</code> (as of EMR 5.14.0). Case insensitive.</p>
</dd><dt class="property-optional"
            title="Optional">
