...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#endpointtype_csharp" style="color: inherit; text-decoration: inherit;">Endpoint<wbr>Type</a>
    ...
    <dd><p>The type of endpoint. Can be one of <code>source | target</code>.</p>
</dd><dt class="property-required"
            title="Required">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#enginename_csharp" style="color: inherit; text-decoration: inherit;">Engine<wbr>Name</a>
    ...
    <dd><p>The type of engine for the endpoint. Can be one of <code>aurora | aurora-postgresql| azuredb | db2 | docdb | dynamodb | elasticsearch | kafka | kinesis | mariadb | mongodb | mysql | oracle | postgres | redshift | s3 | sqlserver | sybase</code>.</p>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#s3settings_csharp" style="color: inherit; text-decoration: inherit;">S3Settings</a>
    ...
    <dd><p>Configuration block with S3 settings. Detailed below.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#secretsmanageraccessrolearn_csharp" style="color: inherit; text-decoration: inherit;">Secrets<wbr>Manager<wbr>Access<wbr>Role<wbr>Arn</a>
    ...
    <dd><p>Amazon Resource Name (ARN) of the IAM role that specifies AWS DMS as the trusted entity and has the required permissions to access the value in SecretsManagerSecret.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#secretsmanagerarn_csharp" style="color: inherit; text-decoration: inherit;">Secrets<wbr>Manager<wbr>Arn</a>
    ...
    <dd><p>The full ARN, partial ARN, or friendly name of the SecretsManagerSecret that contains the endpoint connection details. Supported only for <code>engine_name</code> as <code>oracle</code> and <code>postgres</code>.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#sslmode_csharp" style="color: inherit; text-decoration: inherit;">Ssl<wbr>Mode</a>
    ...
    <dd><p>The SSL mode to use for the connection. Can be one of <code>none | require | verify-ca | verify-full</code></p>
</dd><dt class="property-optional"
            title="Optional">
        <span id="tags_csharp">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#endpointuri_csharp" style="color: inherit; text-decoration: inherit;">Endpoint<wbr>Uri</a>
    ...
    <dd><p>Endpoint for the Elasticsearch cluster.</p>
</dd><dt class="property-required"
            title="Required">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#serviceaccessrolearn_csharp" style="color: inherit; text-decoration: inherit;">Service<wbr>Access<wbr>Role<wbr>Arn</a>
    ...
    <dd><p>Amazon Resource Name (ARN) of the IAM Role with permissions to write to the Elasticsearch cluster.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#errorretryduration_csharp" style="color: inherit; text-decoration: inherit;">Error<wbr>Retry<wbr>Duration</a>
    ...
    <dd><p>Maximum number of seconds for which DMS retries failed API requests to the Elasticsearch cluster. Defaults to <code>300</code>.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#fullloaderrorpercentage_csharp" style="color: inherit; text-decoration: inherit;">Full<wbr>Load<wbr>Error<wbr>Percentage</a>
    ...
    <dd><p>Maximum percentage of records that can fail to be written before a full load operation stops. Defaults to <code>10</code>.</p>
</dd></dl>
</pulumi-choosable>
</div>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#includecontroldetails_csharp" style="color: inherit; text-decoration: inherit;">Include<wbr>Control<wbr>Details</a>
    ...
    <dd><p>Shows detailed control information for table definition, column definition, and table and column changes in the Kafka message output. The default is <code>false</code>.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#includenullandempty_csharp" style="color: inherit; text-decoration: inherit;">Include<wbr>Null<wbr>And<wbr>Empty</a>
    ...
    <dd><p>Include NULL and empty columns for records migrated to the endpoint. The default is <code>false</code>.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#includepartitionvalue_csharp" style="color: inherit; text-decoration: inherit;">Include<wbr>Partition<wbr>Value</a>
    ...
    <dd><p>Shows the partition value within the Kafka message output unless the partition type is <code>schema-table-type</code>. The default is <code>false</code>.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#includetablealteroperations_csharp" style="color: inherit; text-decoration: inherit;">Include<wbr>Table<wbr>Alter<wbr>Operations</a>
    ...
    <dd><p>Includes any data definition language (DDL) operations that change the table in the control data, such as <code>rename-table</code>, <code>drop-table</code>, <code>add-column</code>, <code>drop-column</code>, and <code>rename-column</code>. The default is <code>false</code>.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#messageformat_csharp" style="color: inherit; text-decoration: inherit;">Message<wbr>Format</a>
    ...
    <dd><p>The output format for the records created on the endpoint. The message format is <code>JSON</code> (default) or <code>JSON_UNFORMATTED</code> (a single line with no tab).</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#messagemaxbytes_csharp" style="color: inherit; text-decoration: inherit;">Message<wbr>Max<wbr>Bytes</a>
    ...
    <dd><p>The maximum size in bytes for records created on the endpoint The default is <code>1,000,000</code>.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#saslpassword_csharp" style="color: inherit; text-decoration: inherit;">Sasl<wbr>Password</a>
    ...
    <dd><p>The secure password you created when you first set up your MSK cluster to validate a client identity and make an encrypted connection between server and client using SASL-SSL authentication.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#saslusername_csharp" style="color: inherit; text-decoration: inherit;">Sasl<wbr>Username</a>
    ...
    <dd><p>The secure user name you created when you first set up your MSK cluster to validate a client identity and make an encrypted connection between server and client using SASL-SSL authentication.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#sslcacertificatearn_csharp" style="color: inherit; text-decoration: inherit;">Ssl<wbr>Ca<wbr>Certificate<wbr>Arn</a>
    ...
    <dd><p>The Amazon Resource Name (ARN) for the private certificate authority (CA) cert that AWS DMS uses to securely connect to your Kafka target endpoint.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#sslclientcertificatearn_csharp" style="color: inherit; text-decoration: inherit;">Ssl<wbr>Client<wbr>Certificate<wbr>Arn</a>
    ...
    <dd><p>The Amazon Resource Name (ARN) of the client certificate used to securely connect to a Kafka target endpoint.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#sslclientkeyarn_csharp" style="color: inherit; text-decoration: inherit;">Ssl<wbr>Client<wbr>Key<wbr>Arn</a>
    ...
    <dd><p>The Amazon Resource Name (ARN) for the client private key used to securely connect to a Kafka target endpoint.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#sslclientkeypassword_csharp" style="color: inherit; text-decoration: inherit;">Ssl<wbr>Client<wbr>Key<wbr>Password</a>
    ...
    <dd><p>The password for the client private key used to securely connect to a Kafka target endpoint.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#topic_csharp" style="color: inherit; text-decoration: inherit;">Topic</a>
    ...
    <dd><p>Kafka topic for migration. Defaults to <code>kafka-default-topic</code>.</p>
</dd></dl>
</pulumi-choosable>
</div>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#includecontroldetails_csharp" style="color: inherit; text-decoration: inherit;">Include<wbr>Control<wbr>Details</a>
    ...
    <dd><p>Shows detailed control information for table definition, column definition, and table and column changes in the Kinesis message output. The default is <code>false</code>.</p>
</dd><dt class="property-optional"
            title="Optional">
        <span id="includenullandempty_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#includenullandempty_csharp" style="color: inherit; text-decoration: inherit;">Include<wbr>Null<wbr>And<wbr>Empty</a>
    ...
    <dd><p>Include NULL and empty columns in the target. The default is <code>false</code>.</p>
</dd><dt class="property-optional"
            title="Optional">
        <span id="includepartitionvalue_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#includepartitionvalue_csharp" style="color: inherit; text-decoration: inherit;">Include<wbr>Partition<wbr>Value</a>
    ...
    <dd><p>Shows the partition value within the Kinesis message output, unless the partition type is schema-table-type. The default is <code>false</code>.</p>
</dd><dt class="property-optional"
            title="Optional">
        <span id="includetablealteroperations_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#includetablealteroperations_csharp" style="color: inherit; text-decoration: inherit;">Include<wbr>Table<wbr>Alter<wbr>Operations</a>
    ...
    <dd><p>Includes any data definition language (DDL) operations that change the table in the control data. The default is <code>false</code>.</p>
</dd><dt class="property-optional"
            title="Optional">
        <span id="includetransactiondetails_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#includetransactiondetails_csharp" style="color: inherit; text-decoration: inherit;">Include<wbr>Transaction<wbr>Details</a>
    ...
    <dd><p>Provides detailed transaction information from the source database. The default is <code>false</code>.</p>
</dd><dt class="property-optional"
            title="Optional">
        <span id="messageformat_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#messageformat_csharp" style="color: inherit; text-decoration: inherit;">Message<wbr>Format</a>
    ...
    <dd><p>Output format for the records created. Defaults to <code>json</code>. Valid values are <code>json</code> and <code>json_unformatted</code> (a single line with no tab).</p>
</dd><dt class="property-optional"
            title="Optional">
        <span id="partitionincludeschematable_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#partitionincludeschematable_csharp" style="color: inherit; text-decoration: inherit;">Partition<wbr>Include<wbr>Schema<wbr>Table</a>
    ...
    <dd><p>Prefixes schema and table names to partition values, when the partition type is primary-key-type. The default is <code>false</code>.</p>
</dd><dt class="property-optional"
            title="Optional">
        <span id="serviceaccessrolearn_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#serviceaccessrolearn_csharp" style="color: inherit; text-decoration: inherit;">Service<wbr>Access<wbr>Role<wbr>Arn</a>
    ...
    <dd><p>Amazon Resource Name (ARN) of the IAM Role with permissions to write to the Kinesis data stream.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#streamarn_csharp" style="color: inherit; text-decoration: inherit;">Stream<wbr>Arn</a>
    ...
    <dd><p>Amazon Resource Name (ARN) of the Kinesis data stream.</p>
</dd></dl>
</pulumi-choosable>
</div>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#authmechanism_csharp" style="color: inherit; text-decoration: inherit;">Auth<wbr>Mechanism</a>
    ...
    <dd><p>Authentication mechanism to access the MongoDB source endpoint. Defaults to <code>default</code>.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#authsource_csharp" style="color: inherit; text-decoration: inherit;">Auth<wbr>Source</a>
    ...
    <dd><p>Authentication database name. Not used when <code>auth_type</code> is <code>no</code>. Defaults to <code>admin</code>.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#authtype_csharp" style="color: inherit; text-decoration: inherit;">Auth<wbr>Type</a>
    ...
    <dd><p>Authentication type to access the MongoDB source endpoint. Defaults to <code>password</code>.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#docstoinvestigate_csharp" style="color: inherit; text-decoration: inherit;">Docs<wbr>To<wbr>Investigate</a>
    ...
    <dd><p>Number of documents to preview to determine the document organization. Use this setting when <code>nesting_level</code> is set to <code>one</code>. Defaults to <code>1000</code>.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#extractdocid_csharp" style="color: inherit; text-decoration: inherit;">Extract<wbr>Doc<wbr>Id</a>
    ...
    <dd><p>Document ID. Use this setting when <code>nesting_level</code> is set to <code>none</code>. Defaults to <code>false</code>.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#nestinglevel_csharp" style="color: inherit; text-decoration: inherit;">Nesting<wbr>Level</a>
    ...
    <dd><p>Specifies either document or table mode. Defaults to <code>none</code>. Valid values are <code>one</code> (table mode) and <code>none</code> (document mode).</p>
</dd></dl>
</pulumi-choosable>
</div>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#bucketfolder_csharp" style="color: inherit; text-decoration: inherit;">Bucket<wbr>Folder</a>
    ...
    <dd><p>S3 Bucket Object prefix.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#compressiontype_csharp" style="color: inherit; text-decoration: inherit;">Compression<wbr>Type</a>
    ...
    <dd><p>Set to compress target files. Defaults to <code>NONE</code>. Valid values are <code>GZIP</code> and <code>NONE</code>.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#csvdelimiter_csharp" style="color: inherit; text-decoration: inherit;">Csv<wbr>Delimiter</a>
    ...
    <dd><p>Delimiter used to separate columns in the source files. Defaults to <code>,</code>.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#csvrowdelimiter_csharp" style="color: inherit; text-decoration: inherit;">Csv<wbr>Row<wbr>Delimiter</a>
    ...
    <dd><p>Delimiter used to separate rows in the source files. Defaults to <code>\n</code>.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#dataformat_csharp" style="color: inherit; text-decoration: inherit;">Data<wbr>Format</a>
    ...
    <dd><p>The output format for the files that AWS DMS uses to create S3 objects. Defaults to <code>csv</code>. Valid values are <code>csv</code> and <code>parquet</code>.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#datepartitionenabled_csharp" style="color: inherit; text-decoration: inherit;">Date<wbr>Partition<wbr>Enabled</a>
    ...
    <dd><p>Partition S3 bucket folders based on transaction commit dates. Defaults to <code>false</code>.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#encryptionmode_csharp" style="color: inherit; text-decoration: inherit;">Encryption<wbr>Mode</a>
    ...
    <dd><p>The server-side encryption mode that you want to encrypt your .csv or .parquet object files copied to S3. Defaults to <code>SSE_S3</code>. Valid values are <code>SSE_S3</code> and <code>SSE_KMS</code>.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#parquettimestampinmillisecond_csharp" style="color: inherit; text-decoration: inherit;">Parquet<wbr>Timestamp<wbr>In<wbr>Millisecond</a>
    ...
    <dd><ul>
<li>Specifies the precision of any TIMESTAMP column values written to an S3 object file in .parquet format. Defaults to <code>false</code>.</li>
</ul>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#parquetversion_csharp" style="color: inherit; text-decoration: inherit;">Parquet<wbr>Version</a>
    ...
    <dd><p>The version of the .parquet file format. Defaults to <code>parquet-1-0</code>. Valid values are <code>parquet-1-0</code> and <code>parquet-2-0</code>.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#serversideencryptionkmskeyid_csharp" style="color: inherit; text-decoration: inherit;">Server<wbr>Side<wbr>Encryption<wbr>Kms<wbr>Key<wbr>Id</a>
    ...
    <dd><p>If you set encryptionMode to <code>SSE_KMS</code>, set this parameter to the Amazon Resource Name (ARN) for the AWS KMS key.</p>
</dd><dt class="property-optional"
            title="Optional">
        <span id="serviceaccessrolearn_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#serviceaccessrolearn_csharp" style="color: inherit; text-decoration: inherit;">Service<wbr>Access<wbr>Role<wbr>Arn</a>
    ...
    <dd><p>Amazon Resource Name (ARN) of the IAM Role with permissions to read from or write to the S3 Bucket.</p>
</dd></dl>
</pulumi-choosable>
</div>
