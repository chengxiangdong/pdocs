...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#enabled_csharp" style="color: inherit; text-decoration: inherit;">Enabled</a>
    ...
    <dd><p>Whether to enable node-to-node encryption. If the <code>node_to_node_encryption</code> block is not provided then this defaults to <code>false</code>.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#kmskeyid_csharp" style="color: inherit; text-decoration: inherit;">Kms<wbr>Key<wbr>Id</a>
    ...
    <dd><p>KMS key id to encrypt the Elasticsearch domain with. If not specified then it defaults to using the <code>aws/es</code> service KMS key.</p>
</dd></dl>
</pulumi-choosable>
</div>
