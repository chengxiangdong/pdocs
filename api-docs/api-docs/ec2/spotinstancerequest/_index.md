...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#instanceinterruptionbehaviour_csharp" style="color: inherit; text-decoration: inherit;">Instance<wbr>Interruption<wbr>Behaviour</a>
    ...
    <dd><p>Indicates Spot instance behavior when it is interrupted. Valid values are <code>terminate</code>, <code>stop</code>, or <code>hibernate</code>. Default value is <code>terminate</code>. Use the argument <code>instance_interruption_behavior</code> instead.</p>
<p class="property-message">Deprecated:<p>Use the parameter &quot;instance_interruption_behavior&quot; instead.</p>
