...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#branchfilter_csharp" style="color: inherit; text-decoration: inherit;">Branch<wbr>Filter</a>
    ...
    <dd><p>A regular expression used to determine which branches get built. Default is all branches are built. It is recommended to use <code>filter_group</code> over <code>branch_filter</code>.</p>
</dd><dt class="property-optional"
            title="Optional">
