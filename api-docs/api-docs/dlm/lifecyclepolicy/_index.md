...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#resourcetypes_csharp" style="color: inherit; text-decoration: inherit;">Resource<wbr>Types</a>
    ...
    <dd><p>A list of resource types that should be targeted by the lifecycle policy. <code>VOLUME</code> is currently the only allowed value.</p>
</dd><dt class="property-required"
            title="Required">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#count_csharp" style="color: inherit; text-decoration: inherit;">Count</a>
    ...
    <dd><p>How many snapshots to keep. Must be an integer between 1 and 1000.</p>
</dd></dl>
</pulumi-choosable>
</div>
