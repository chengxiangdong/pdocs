...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#kmskey_csharp" style="color: inherit; text-decoration: inherit;">Kms<wbr>Key</a>
    ...
    <dd><p>The ARN of the KMS key used for encryption.</p>
</dd></dl>
</pulumi-choosable>
</div>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#healthythreshold_csharp" style="color: inherit; text-decoration: inherit;">Healthy<wbr>Threshold</a>
    ...
    <dd><p>The number of consecutive checks that must succeed before App Runner decides that the service is healthy. Defaults to 1. Minimum value of 1. Maximum value of 20.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#interval_csharp" style="color: inherit; text-decoration: inherit;">Interval</a>
    ...
    <dd><p>The time interval, in seconds, between health checks. Defaults to 5. Minimum value of 1. Maximum value of 20.</p>
</dd><dt class="property-optional"
            title="Optional">
        <span id="path_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#path_csharp" style="color: inherit; text-decoration: inherit;">Path</a>
    ...
    <dd><p>The URL to send requests to for health checks. Defaults to <code>/</code>. Minimum length of 0. Maximum length of 51200.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#protocol_csharp" style="color: inherit; text-decoration: inherit;">Protocol</a>
    ...
    <dd><p>The IP protocol that App Runner uses to perform health checks for your service. Valid values: <code>TCP</code>, <code>HTTP</code>. Defaults to <code>TCP</code>. If you set protocol to <code>HTTP</code>, App Runner sends health check requests to the HTTP path specified by <code>path</code>.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#timeout_csharp" style="color: inherit; text-decoration: inherit;">Timeout</a>
    ...
    <dd><p>The time, in seconds, to wait for a health check response before deciding it failed. Defaults to 2. Minimum value of  1. Maximum value of 20.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#unhealthythreshold_csharp" style="color: inherit; text-decoration: inherit;">Unhealthy<wbr>Threshold</a>
    ...
    <dd><p>The number of consecutive checks that must fail before App Runner decides that the service is unhealthy. Defaults to 5. Minimum value of  1. Maximum value of 20.</p>
</dd></dl>
</pulumi-choosable>
</div>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#cpu_csharp" style="color: inherit; text-decoration: inherit;">Cpu</a>
    ...
    <dd><p>The number of CPU units reserved for each instance of your App Runner service represented as a String. Defaults to <code>1024</code>. Valid values: <code>1024|2048|(1|2) vCPU</code>.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#instancerolearn_csharp" style="color: inherit; text-decoration: inherit;">Instance<wbr>Role<wbr>Arn</a>
    ...
    <dd><p>The Amazon Resource Name (ARN) of an IAM role that provides permissions to your App Runner service. These are permissions that your code needs when it calls any AWS APIs.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#memory_csharp" style="color: inherit; text-decoration: inherit;">Memory</a>
    ...
    <dd><p>The amount of memory, in MB or GB, reserved for each instance of your App Runner service. Defaults to <code>2048</code>. Valid values: <code>2048|3072|4096|(2|3|4) GB</code>.</p>
</dd></dl>
</pulumi-choosable>
</div>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#repositoryurl_csharp" style="color: inherit; text-decoration: inherit;">Repository<wbr>Url</a>
    ...
    <dd><p>The location of the repository that contains the source code.</p>
</dd><dt class="property-required"
            title="Required">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#sourcecodeversion_csharp" style="color: inherit; text-decoration: inherit;">Source<wbr>Code<wbr>Version</a>
    ...
    <dd><p>The version that should be used within the source code repository. See Source Code Version below for more details.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#configurationsource_csharp" style="color: inherit; text-decoration: inherit;">Configuration<wbr>Source</a>
    ...
    <dd><p>The source of the App Runner configuration. Valid values: <code>REPOSITORY</code>, <code>API</code>. Values are interpreted as follows:</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#runtime_csharp" style="color: inherit; text-decoration: inherit;">Runtime</a>
    ...
    <dd><p>A runtime environment type for building and running an App Runner service. Represents a programming language runtime. Valid values: <code>PYTHON_3</code>, <code>NODEJS_12</code>.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#buildcommand_csharp" style="color: inherit; text-decoration: inherit;">Build<wbr>Command</a>
    ...
    <dd><p>The command App Runner runs to build your application.</p>
</dd><dt class="property-optional"
            title="Optional">
        <span id="port_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#port_csharp" style="color: inherit; text-decoration: inherit;">Port</a>
    ...
    <dd><p>The port that your application listens to in the container. Defaults to <code>&quot;8080&quot;</code>.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#startcommand_csharp" style="color: inherit; text-decoration: inherit;">Start<wbr>Command</a>
    ...
    <dd><p>The command App Runner runs to start your application.</p>
</dd></dl>
</pulumi-choosable>
</div>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#type_csharp" style="color: inherit; text-decoration: inherit;">Type</a>
    ...
    <dd><p>The type of version identifier. For a git-based repository, branches represent versions. Valid values: <code>BRANCH</code>.</p>
</dd><dt class="property-required"
            title="Required">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#value_csharp" style="color: inherit; text-decoration: inherit;">Value</a>
    ...
    <dd><p>A source code version. For a git-based repository, a branch name maps to a specific version. App Runner uses the most recent commit to the branch.</p>
</dd></dl>
</pulumi-choosable>
</div>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#imageidentifier_csharp" style="color: inherit; text-decoration: inherit;">Image<wbr>Identifier</a>
    ...
    <dd><p>The identifier of an image. For an image in Amazon Elastic Container Registry (Amazon ECR), this is an image name. For the
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#imagerepositorytype_csharp" style="color: inherit; text-decoration: inherit;">Image<wbr>Repository<wbr>Type</a>
    ...
    <dd><p>The type of the image repository. This reflects the repository provider and whether the repository is private or public. Valid values: <code>ECR</code> , <code>ECR_PUBLIC</code>.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#startcommand_csharp" style="color: inherit; text-decoration: inherit;">Start<wbr>Command</a>
    ...
    <dd><p>A command App Runner runs to start the application in the source image. If specified, this command overrides the Docker image’s default start command.</p>
</dd></dl>
</pulumi-choosable>
</div>
