...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#nameregex_csharp" style="color: inherit; text-decoration: inherit;">Name<wbr>Regex</a>
    ...
    <dd><p>A regex string to apply to the IAM users list returned by AWS. This allows more advanced filtering not supported from the AWS API.
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#pathprefix_csharp" style="color: inherit; text-decoration: inherit;">Path<wbr>Prefix</a>
    ...
    <dd><p>The path prefix for filtering the results. For example, the prefix <code>/division_abc/subdivision_xyz/</code> gets all users whose path starts with <code>/division_abc/subdivision_xyz/</code>. If it is not included, it defaults to a slash (<code>/</code>), listing all users. For more details, check out [list-users in the AWS CLI reference][1].</p>
</dd></dl>
</pulumi-choosable>
</div>
